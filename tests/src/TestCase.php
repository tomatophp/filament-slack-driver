...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        $providers = [
            ...
            FilamentSlackDriverServiceProvider::class,
    ...
    public function getEnvironmentSetUp($app): void
    {
        ...
        $app['config']->set('filament-slack-driver.webhook', 'https://hooks.slack.test/services/T000/B000/xxx');
        $app['config']->set('filament-slack-driver.token', null);
        $app['config']->set('filament-slack-driver.channel', null);
        $app['config']->set('filament-slack-driver.active', true);
